...
class Workout extends React.Component {
  constructor(props) {
    ...
    this.handleInitialDateSetup = this.handleInitialDateSetup.bind(this);
  }

  componentWillMount() {
    this.handleInitialDateSetup();
  }

  handleInitialDateSetup() {
    this.setState({
      startDate: new Date(this.props.workoutDateInput)
    });
  }
  ...
  render() {
    const { dispatch, workoutNotesState, workoutNotes, withoutSavingPopUpModalShown, finishedWorkoutPopUpModalShown, workoutTitleInput, workoutDateInput, workoutNotesInput, masterExerciseList, pageLink, ifEdit, selectedWorkoutToBeEditedID }
    = this.props;
        ...
        <div style={workoutFormStyles}>
          ...
          <DatePicker
            ...
            onSelect={(event) => {
              ...
              dispatch(onInputChange('workout', 'workoutDateInput', event.getTime()));
            }}
          />
          {workoutNotesInputField}
        </div>
...
Workout.propTypes = {
  ...
  workoutDateInput: PropTypes.number,
